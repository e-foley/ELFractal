...
<meta name="Description" content="A large, colorful fractal gallery with hundreds of Apophysis and Incendia images." />
<meta name="Keywords" content="apophysis, incendia, fractal, flame, gallery" />
<style type="text/css">
...
<title>Empyreal Light - Apophysis and Incendia Fractal Gallery</title>
</head>
<body>
...
<?php
if ($_COOKIE["VIP"])
  echo("<table class='content intro alt'>");
else
  echo("<table class='content intro standard'>");
?>

<tr><td>
<div class="introtext">Empyreal Light</div>
<div class="introtextsmall">Fractals by Edward Foley</div>
</td></tr></table>
...
<div style="font-weight: bold;">Host issues</div>
<div>Unfortunately, our host is having some serious issues with their PHP configuration.
This site is almost entirely unusable until further notice.  Sorry for the inconvenience.</div>
<div>&mdash;Ed</div>
</td></tr></table>-->
